...
export function SplashPage() {
  ...
  return (
    <div className="flex flex-col min-h-dvh">
      {/* Hero */}
      <div className="bg-gradient-to-b from-crown-navy via-crown-navy to-crown-deep flex-1 flex flex-col items-center justify-center px-6 pt-16 pb-10 relative overflow-hidden">
        ...
        >
          <div className="flex-1 bg-white/10 backdrop-blur rounded-2xl p-4 text-center">
            <p className="text-xs text-white/40 uppercase tracking-wide mb-1">Compra</p>
            <p className="text-2xl font-bold text-crown-gold-light">3.720</p>
          </div>
          <div className="flex-1 bg-white/10 backdrop-blur rounded-2xl p-4 text-center">
            <p className="text-xs text-white/40 uppercase tracking-wide mb-1">Venta</p>
